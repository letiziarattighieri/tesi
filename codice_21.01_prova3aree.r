#Faccio una prova con solo 3 aree: wa1, gu4, ey1
#Osservazioni: ho creato poligoni "erba" anche in zone con erba secca che presenta pixel dello stesso colore
#di alcuni fiori e il modello me li considera comunque come fiori. 
#Così come anche pali e fili delle staccionate
...
setwd("C:/prova_multi")
ortho <- list.files(pattern = "prova", 
                    full.names = TRUE)%>% 
...
saveRDS(RF, file = "C:/model_prova_RF.rds")
